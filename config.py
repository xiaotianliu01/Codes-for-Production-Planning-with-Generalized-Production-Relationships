...
def get_config():
    ...
    parser.add_argument("--n_eval_rollout_threads", type=int, default=30,
                        help="Number of parallel envs for evaluating rollouts")
    parser.add_argument("--num_env_steps", type=int, default=3e8,
                        help='Number of environment steps to train (default: 10e6)')
    parser.add_argument("--update_per_agent", type=int, default=5, help="number of episodes of a single update of one agent.")
    parser.add_argument("--user_name", type=str, default='marl',help="[for wandb usage], to specify user's name for simply collecting training data.")
    
    # env parameters
    parser.add_argument("--env_name", type=str, default='SMLP', help="specify the name of environment")
    parser.add_argument("--experiment_name", type=str, default="Clearing_Function_Exp", help="Fixed_Production_Lead_Time or Clearing_Function_Frac or Clearing_Function_Exp or Clearing_Function_Poly")
    parser.add_argument("--use_obs_instead_of_state", action='store_true',
                            default=False, help="Whether to use global state or concatenated obs")
    parser.add_argument("--data_pth", type=str, default = './data/MSOM-06-038-R2.xls', help="by default None. set the path to data.")
    parser.add_argument("--instance_id", type=str, default = '00', help="by default None. instance id of production net.")
    parser.add_argument("--reward_lambda", type=float, default = 0.7, help="lambda in cost design.")
    ...
    parser.add_argument("--verbose", action='store_true', default=False, help="print training details")
    ...
    parser.add_argument("--eval_interval", type=int, default=30, help="time duration between contiunous twice evaluation progress.")
    parser.add_argument("--no_improvement_episodes", type=int, default=20, help="no improvement episodes to terminate.")
